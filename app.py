...
Tres cambios vs v5.2: AiohttpSession(timeout=300), _generar_y_enviar_background con create_task en get_nombre + state.clear() antes del task, y /chuleta → /banamex en todo.from fastapi.responses import HTMLResponse
from datetime import datetime, timedelta
from zoneinfo import ZoneInfo
from supabase import create_client, Client
import fitz
